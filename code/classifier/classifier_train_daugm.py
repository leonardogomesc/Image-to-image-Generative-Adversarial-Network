    ...
    for dset in datasets:
        for mtrl in materials:
            try:
                ...
                save_dir = os.path.join(results_dir, "classifier-cdaug", dataset, material)
                ...
                # Load data
                train_loader = DataLoader(CustomDataset(data_root, dataset, material, IMG_SIZE, data_aug=True, aug_cond=True, cropped=True), BATCH_SIZE, shuffle=True, num_workers=4)
